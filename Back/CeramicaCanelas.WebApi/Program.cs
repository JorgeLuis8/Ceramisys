...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddCors(options =>
        {
            ...
            {
                policy.WithOrigins("http://localhost:3001", "http://localhost:5236", "https://localhost:7018", "https://ceramicacanelas.shop", "https://www.ceramicacanelas.shop", "http://ceramicacanelas.shop", "http://localhost:3000", "https://www.ceramisys.shop") // Adicione os domínios permitidos aqui
                      .AllowAnyMethod()
                      .AllowAnyHeader()
